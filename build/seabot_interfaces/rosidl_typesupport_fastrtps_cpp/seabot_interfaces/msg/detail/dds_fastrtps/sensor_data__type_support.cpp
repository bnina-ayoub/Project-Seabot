...
#include "seabot_interfaces/msg/detail/sensor_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = seabot_interfaces::msg::SensorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const seabot_interfaces::msg::SensorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<seabot_interfaces::msg::SensorData *>(
    untyped_ros_message);
...
{
  return &seabot_interfaces::msg::typesupport_fastrtps_cpp::_SensorData__handle;
}
