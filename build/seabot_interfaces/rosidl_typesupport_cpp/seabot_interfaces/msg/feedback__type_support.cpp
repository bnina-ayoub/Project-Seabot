...
static const _Feedback_type_support_symbol_names_t _Feedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, seabot_interfaces, msg, Feedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, seabot_interfaces, msg, Feedback)),
  }
};
...
{
  return &::seabot_interfaces::msg::rosidl_typesupport_cpp::Feedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, seabot_interfaces, msg, Feedback)() {
  return get_message_type_support_handle<seabot_interfaces::msg::Feedback>();
}
