...
#include "seabot_interfaces/msg/detail/sensor_data__rosidl_typesupport_fastrtps_c.h"
...
using _SensorData__ros_msg_type = seabot_interfaces__msg__SensorData;
...
size_t get_serialized_size_seabot_interfaces__msg__SensorData(
  const void * untyped_ros_message,
...
static uint32_t _SensorData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_seabot_interfaces__msg__SensorData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_seabot_interfaces
size_t max_serialized_size_seabot_interfaces__msg__SensorData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = seabot_interfaces__msg__SensorData;
    is_plain =
      (
...
static size_t _SensorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_seabot_interfaces__msg__SensorData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seabot_interfaces, msg, SensorData)() {
