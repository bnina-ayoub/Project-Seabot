...
#include <stddef.h>
#include "custom_interfaces/msg/detail/sensor_data__rosidl_typesupport_introspection_c.h"
#include "custom_interfaces/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "custom_interfaces/msg/detail/sensor_data__functions.h"
#include "custom_interfaces/msg/detail/sensor_data__struct.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_interfaces__msg__SensorData__init(message_memory);
}

void SensorData__rosidl_typesupport_introspection_c__SensorData_fini_function(void * message_memory)
{
  custom_interfaces__msg__SensorData__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SensorData__rosidl_typesupport_introspection_c__SensorData_message_member_array[2] = {
  {
    "data",  // name
    ...
    offsetof(custom_interfaces__msg__SensorData, data),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__SensorData, temp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SensorData__rosidl_typesupport_introspection_c__SensorData_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interfaces__msg__SensorData),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, SensorData)() {
