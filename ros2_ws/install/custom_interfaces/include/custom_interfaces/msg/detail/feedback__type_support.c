...
#include <stddef.h>
#include "custom_interfaces/msg/detail/feedback__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_interfaces__msg__Feedback__init(message_memory);
}

void Feedback__rosidl_typesupport_introspection_c__Feedback_fini_function(void * message_memory)
{
  custom_interfaces__msg__Feedback__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Feedback__rosidl_typesupport_introspection_c__Feedback_message_member_array[1] = {
  {
    "feedback",  // name
    ...
    offsetof(custom_interfaces__msg__Feedback, feedback),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Feedback__rosidl_typesupport_introspection_c__Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces__msg__Feedback),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, Feedback)() {
