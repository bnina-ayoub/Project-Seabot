...
{
  new (message_memory) custom_interfaces::msg::Feedback(_init);
}

void Feedback_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::Feedback *>(message_memory);
  typed_message->~Feedback();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Feedback_message_member_array[1] = {
  {
    "feedback",  // name
    ...
    offsetof(custom_interfaces::msg::Feedback, feedback),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces::msg::Feedback),
...
get_message_type_support_handle<custom_interfaces::msg::Feedback>()
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Feedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, Feedback)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Feedback_message_type_support_handle;
}
