...
static const _Feedback_type_support_symbol_names_t _Feedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seabot_interfaces, msg, Feedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, seabot_interfaces, msg, Feedback)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, seabot_interfaces, msg, Feedback)() {
  return &::seabot_interfaces::msg::rosidl_typesupport_c::Feedback_message_type_support_handle;
}
