...
#include "seabot_interfaces/srv/detail/service__rosidl_typesupport_fastrtps_c.h"
...
#include "seabot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Service_Request__ros_msg_type = seabot_interfaces__srv__Service_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_seabot_interfaces
size_t get_serialized_size_seabot_interfaces__srv__Service_Request(
  const void * untyped_ros_message,
...
static uint32_t _Service_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_seabot_interfaces__srv__Service_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_seabot_interfaces
size_t max_serialized_size_seabot_interfaces__srv__Service_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = seabot_interfaces__srv__Service_Request;
    is_plain =
      (
...
static size_t _Service_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_seabot_interfaces__srv__Service_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seabot_interfaces, srv, Service_Request)() {
...
using _Service_Response__ros_msg_type = seabot_interfaces__srv__Service_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_seabot_interfaces
size_t get_serialized_size_seabot_interfaces__srv__Service_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Service_Response__ros_msg_type * ros_message = static_cast<const _Service_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_seabot_interfaces__srv__Service_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_seabot_interfaces
size_t max_serialized_size_seabot_interfaces__srv__Service_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = seabot_interfaces__srv__Service_Response;
    is_plain =
      (
...
static size_t _Service_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_seabot_interfaces__srv__Service_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seabot_interfaces, srv, Service_Response)() {
...
// already included above
// #include "seabot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "seabot_interfaces/srv/service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seabot_interfaces, srv, Service)() {
