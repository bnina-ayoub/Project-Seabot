...
#include "seabot_interfaces/msg/detail/feedback__rosidl_typesupport_fastrtps_c.h"
...
using _Feedback__ros_msg_type = seabot_interfaces__msg__Feedback;
...
size_t get_serialized_size_seabot_interfaces__msg__Feedback(
  const void * untyped_ros_message,
...
static uint32_t _Feedback__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_seabot_interfaces__msg__Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_seabot_interfaces
size_t max_serialized_size_seabot_interfaces__msg__Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = seabot_interfaces__msg__Feedback;
    is_plain =
      (
...
static size_t _Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_seabot_interfaces__msg__Feedback(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seabot_interfaces, msg, Feedback)() {
