...
static const _Service_Request_type_support_symbol_names_t _Service_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seabot_interfaces, srv, Service_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, seabot_interfaces, srv, Service_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, seabot_interfaces, srv, Service_Request)() {
  return &::seabot_interfaces::srv::rosidl_typesupport_c::Service_Request_message_type_support_handle;
}
...
static const _Service_Response_type_support_symbol_names_t _Service_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seabot_interfaces, srv, Service_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, seabot_interfaces, srv, Service_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, seabot_interfaces, srv, Service_Response)() {
  return &::seabot_interfaces::srv::rosidl_typesupport_c::Service_Response_message_type_support_handle;
}
...
static const _Service_type_support_symbol_names_t _Service_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, seabot_interfaces, srv, Service)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, seabot_interfaces, srv, Service)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, seabot_interfaces, srv, Service)() {
  return &::seabot_interfaces::srv::rosidl_typesupport_c::Service_service_type_support_handle;
}
