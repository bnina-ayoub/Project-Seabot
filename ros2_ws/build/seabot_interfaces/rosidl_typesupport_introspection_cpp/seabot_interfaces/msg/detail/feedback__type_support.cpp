...
{
  new (message_memory) seabot_interfaces::msg::Feedback(_init);
}

void Feedback_fini_function(void * message_memory)
{
  auto typed_message = static_cast<seabot_interfaces::msg::Feedback *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Feedback_message_member_array[1] = {
  {
    ...
    offsetof(seabot_interfaces::msg::Feedback, feedback),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(seabot_interfaces::msg::Feedback),
...
{
  return &::seabot_interfaces::msg::rosidl_typesupport_introspection_cpp::Feedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, seabot_interfaces, msg, Feedback)() {
  return &::seabot_interfaces::msg::rosidl_typesupport_introspection_cpp::Feedback_message_type_support_handle;
}
