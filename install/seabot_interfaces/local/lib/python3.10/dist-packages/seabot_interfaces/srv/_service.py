...
class Metaclass_Service_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('seabot_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Service(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from seabot_interfaces.srv import _service
...
class Service(metaclass=Metaclass_Service):
    from seabot_interfaces.srv._service import Service_Request as Request
    from seabot_interfaces.srv._service import Service_Response as Response
